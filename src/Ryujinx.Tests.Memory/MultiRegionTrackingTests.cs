...
namespace Ryujinx.Tests.Memory
{
    public class MultiRegionTrackingTests
    {
        ...
        public void DisposeMultiHandles([Values] bool smart)
        {
            ...
            Assert.That(_tracking.GetRegionCount(), Is.EqualTo(totalPages));
        ...
        public void InheritHandles()
        {
            ...
            for (int i = 0; i < 18; i++)
            {
                ...
                Assert.That(modified, Is.EqualTo(expectedDirty[i]));
            }

            Assert.That(actionsTriggered, Is.EqualTo(new bool[3]));
        ...
        public void PreciseAction()
        {
            ...
            Assert.That(pagesModified, Is.EqualTo(_expectedPagesModified));
        }
    }
}
